    ...
    <main className="min-h-[90vh] w-full bg-[url('/asset14.png')] bg-cover bg-center">
      <div className='h-[90vh] w-full bg-black/40'>
        ...
        <div className='w-1/2 mx-auto flex flex-col gap-8 max-lg:w-full'>
          ...
          {
            session ? 
          <a href='/post-product' className='bg-red-500 text-white font-semibold w-fit mx-auto rounded-md px-5 py-3 text-2xl hover:bg-white hover:text-red-500 hover:scale-105 duration-300' >
            Shop Now
          </a> : (

          <a href='/auth/signin' className='bg-red-500 text-white font-semibold w-fit mx-auto rounded-md px-5 py-3 text-2xl hover:bg-white hover:text-red-500 hover:scale-105 duration-300' >
            Shop Now
          </a>
          )
          }
